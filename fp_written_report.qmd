...
In addition to requesting participation in our survey from our friends at Smith, we posted our Google Form on Smith Confession to increrase diversity in the observations from Smithies. Evelyn also had her Vietnamese friends post it on Meta posts and stories to seek responses from their network of Vietnamese college students. Our friends at colleges other than Smith in the USA also shared our survey with their acquaintances, which helped widen the scope of our survey's observations to include students from as many colleges as possible.
...
@tbl-sleep-productivity and the corresponding @fig-sleep-productivity show the distribution of the observed values of productivity levels across different sleep duration. 
...
If college students' weekday sleep durations and productivity levels are truly independent under the null hypothesis $H_0$ of independence, our expected count - the frequency that would be expected in a cell - for all cells would be as follows:
